...
if __name__ == '__main__':
    ...
    def run_model(dim,l,head):#params
        ...
        for index in range(1,6):
            ###### Dataset
            df_ddi_train = pd.read_csv('../data/cross5datasets/S2/TrainS2_idx_cross'+str(index)+'.csv')
            ...
            df_ddi_test = pd.read_csv('../data/cross5datasets/S2/TestS2_idx_cross' + str(index) + '.csv')
