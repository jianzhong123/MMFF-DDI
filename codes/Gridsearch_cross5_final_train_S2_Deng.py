...
if __name__ == '__main__':
    ...
    def run_model(dim,l,head):#params
        ...
        for index in range(1,6):
            ###### Dataset
            df_ddi_train = pd.read_csv('../data/Dengcross5datasets/Deng_S2/S2_DDIMDL_idx_train_cross_'+str(index)+'.csv')
            ...
            df_ddi_test = pd.read_csv('../data/Dengcross5datasets/Deng_S2/S2_DDIMDL_idx_test_cross_' + str(index) + '.csv')
